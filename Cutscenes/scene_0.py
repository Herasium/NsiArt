...
class Scene0():
    ...
    def _setup_scene(self):
        ...
        self.scene.Entity(layer=layers.background, name="text_bg", size=Vec2(1260, 252), position=Vec2(330, 800), texture="Assets/Textures/Fonts/Background/back_1.raw")
        self.scene.Text(layer=layers.background, name="textline", font=self.core.monogram_big, position=Vec2(360, 845), size=Vec2(50, 500), text="")
